...
ParseOptions(const int argc, char** argv) {
    ...
    od.add_options()
        ...
        ("server_config", value<std::string>()->default_value("configs/server.pbtxt"), "server_config")
        ("annotator_config", value<std::string>()->default_value("configs/annotator.pbtxt"), "annotator_config")
        ("clusterer_config", value<std::string>()->default_value("configs/clusterer.pbtxt"), "clusterer_config")
        ("summarizer_config", value<std::string>()->default_value("configs/summarizer.pbtxt"), "summarizer_config")
        ("ranker_config", value<std::string>()->default_value("configs/ranker.pbtxt"), "ranker_config")
