...
ParseOptions(const int argc, char** argv) {
    ...
    od.add_options()
        ...
        ("server_config", value<std::string>()->default_value("configs/driver/server.pbtxt"), "server_config")
        ("annotator_config", value<std::string>()->default_value("configs/driver/annotator.pbtxt"), "annotator_config")
        ("clusterer_config", value<std::string>()->default_value("configs/driver/clusterer.pbtxt"), "clusterer_config")
        ("summarizer_config", value<std::string>()->default_value("configs/driver/summarizer.pbtxt"), "summarizer_config")
        ("ranker_config", value<std::string>()->default_value("configs/driver/ranker.pbtxt"), "ranker_config")
        ("languages", value<std::vector<std::string>>()->multitoken()->default_value(std::vector<std::string>{"ru", "en"}, "ru en"), "languages")
        ("ndocs", value<int>()->default_value(-1), "ndocs")
        ...
        ("print_top_debug_info", bool_switch()->default_value(false), "print_top_debug_info")
    ;
